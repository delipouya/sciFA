...
thr = 0.05
cov_level_names =names(table(res_df_model$covariate_level))
...
summary_df_m_meanimp$scale_type = unlist(lapply(strsplit(as.character(summary_df_m_meanimp$Var2), '-'), '[[', 3))
