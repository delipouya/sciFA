...
library(stringr)
source("~/dreamlet_analysis/Nathan_NatImm_2021/read.sparseMatrix.R")

# set working directory for input and output files
wd = "~/dreamlet_analysis/Nathan_NatImm_2021/"
setwd(wd)
...
library(Seurat)
sce_seur =  as.Seurat(sce, counts = "counts", data = "counts")
# write to h5ad
saveRDS(sce_seur, '~/sciFA/Data/Nathan_NatImm_2021.rds')
